...
<!-- Center colunm-->
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    ...
                    $datasub=mysql_query("SELECT * FROM tb_menu WHERE id_isi_sub='$kode' ");
                        while($data=mysql_fetch_array($datasub)){
							//$datamenu=mysql_fetch_array(mysql_query("SELECT * FROM tb_menu WHERE id_isi_sub='".$data['id_sub']."' "));
                    ?>
                                ...
                                <div class="left-block">
                                    ...
                                    <div class="add-to-cart">
                                        <?php 
                                            ...
                                            ?>
												<a title="Add to Cart" href="proses/tambah-keranjang.php?menu=<?php echo $data['id_menu'] ?>&&user=<?php echo base64_encode($_SESSION['id_user']) ?>&&kode=<?php echo $kode ?>">Lihat Menu</a>
											<?php 
