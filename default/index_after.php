                            ...
                            <div id="tab-1" class="tab-panel active">
                                ...
                                $promo=mysql_query("SELECT * FROM tb_promo ORDER BY id_promo DESC");
                                    ...
                                    while($datapromo=mysql_fetch_array($promo)){
                                        ...
                                        $cektempat=mysql_fetch_array(mysql_query("SELECT * FROM tb_isi_sub_kategori WHERE id_isi_sub='".$menu['id_isi_sub']."' "));
                                    ...
                                    <li class="col-md-8">
                                        ...
                                        <div class="left-block">
                                            ...
                                            <div class="add-to-cart">
                                                ...
                                                <a title="Add to Cart" href="proses/tambah-keranjang.php?menu=<?php echo $menu['id_menu'] ?>&&kode=<?php echo base64_encode($cektempat['id_isi_sub']) ?>&&user=<?php echo base64_encode($_SESSION['id_user']) ?>&&url=index">Pesan Menu</a>
                            ...
                            <div class="tab-panel active" id="tab-4">
                                ...
                                $query=mysql_query("SELECT * FROM tb_menu ORDER BY id_menu ASC LIMIT 4");
                                    ...
                                    while($datamenu=mysql_fetch_array($query)){
                                        ...
                                        $cektempat=mysql_fetch_array(mysql_query("SELECT * FROM tb_isi_sub_kategori WHERE id_isi_sub='".$datamenu['id_isi_sub']."' "));
                                    ...
                                    <li>
                                        ...
                                        <div class="left-block">
                                            ...
                                            <div class="add-to-cart">
                                                ...
                                                <a title="Add to Cart" href="proses/tambah-keranjang.php?menu=<?php echo $datamenu['id_menu'] ?>&&kode=<?php echo base64_encode($cektempat['id_isi_sub']) ?>&&user=<?php echo base64_encode($_SESSION['id_user']) ?>&&url=index">Pesan Menu</a>
