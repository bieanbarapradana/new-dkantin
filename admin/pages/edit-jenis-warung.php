			...
			<div id="main">
				<div class="container-fluid">
					...
					$kode=base64_decode($_GET['kode']);
						$data=mysql_fetch_array(mysql_query("SELECT * FROM tb_sub_kategori WHERE id_sub='$kode' "));

						if(isset($_POST['jenis'])){
							$kode=base64_decode($_GET['kode']);
							mysql_query("UPDATE tb_sub_kategori SET id_kategori='".$_POST['kategori']."' , sub_kategori='".$_POST['jenis']."' WHERE id_sub='$kode' ");
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-append">
													<input type="text" name="jenis" value="<?php echo $data['sub_kategori'] ?>" required>
